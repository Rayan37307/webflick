...
export const metadata: Metadata = {
  ...
  description:
    "From custom full-stack solutions to WordPress, and what then Webflow & Shopify—Webflick builds websites that convert. Modern, scalable & creative web design for your business.",
  keywords: [
    "web design",
    "web development",
    "custom websites",
